function algorithm()
{
	...
	document.getElementById('matrix').innerHTML += 'Alignement 1:' + result[1] + '<br>';
	document.getElementById('matrix').innerHTML += 'Alignement 2:' + result[0] + '<br><br>';
	document.getElementById('matrix').innerHTML += 'Matrice séquences :' + this.matseq + '<br>';
